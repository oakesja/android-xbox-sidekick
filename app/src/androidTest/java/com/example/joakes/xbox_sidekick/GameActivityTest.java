...
public class GameActivityTest extends ActivityInstrumentationTestCase2<GameActivity> {
    ...
    public void testProfileVisible(){
        ...
        assertTextView((TextView)solo.getView(R.id.gamerscore_textview)).hasAnyText();
    ...
    public void testGamesVisible(){
        ...
        assertTextView((TextView)solo.getView(R.id.gamerscore_textview)).hasAnyText();
        assertTextView((TextView)solo.getView(R.id.game_achievements_textview)).hasAnyText();
    }
}
